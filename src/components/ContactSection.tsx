...
import whatsappImg from "@/assets/whatsapp-logo_cuadrado.jpg";
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <a href="https://wa.me/34627238138?text=LLAMADA%20DE%20WEB%20-%20Solicito%20presupuesto" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
              <div className="bg-eco w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                <img 
                  src={whatsappImg} 
                  alt="WhatsApp Auxilio" 
